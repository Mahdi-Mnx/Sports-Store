  ...
  return (
    <>
      <motion.section className="pt-24 container max-w-screen-2xl px-6 py-12">
        ...
        <p className="mb-4">
          At GOG, we are committed to protecting your privacy. This Privacy
        ...
        <p className="mb-4">
          ...
          payment information. Additionally, we may collect information
        ...
        <p className="mb-4">
          ...
          such as your preferences and settings, interaction with our website,
          and traffic data.
        </p>
        ...
        <p className="mb-4">
          ...
          assist us in operating our website, conducting our business, and
          serving you. These third parties are obligated to protect your
          information and use it only for the purposes for which it was
          disclosed. We may also share your information with:
        </p>
        <ul className="list-disc list-inside mb-4">
        ...
        <p className="mb-4">
          ...
          controls, and secure servers. However, no method of transmission over
        ...
        <p className="mb-4">
          ...
          browsing experience and gather information about visitors and visits
          to our website. Cookies are small files that a site or its service
        ...
        <ul className="list-disc list-inside mb-4">
          ...
          <li>The right to withdraw consent at any time 14d</li>
        </ul>
        <p className="mb-4">
        ...
        <p className="mb-4">
          ...
          information from a visitor under the age of 13, we will delete the
