...
const Store = () => {
  ...
  return (
    <>
      <motion.section
        className="container max-w-screen-xl max-h-screen pt-10 py-3 px-6"
      ...
      >
        <div className="max-h-screen flex justify-around items-center">
          ...
          <div className="w-[50%] h-auto">
            <div className="w-[80%]">
              <h4 className="text-xl text-orange font-medium mt-[-80px]">
                Nike
              </h4>
              <h1 className="text-5xl text-black font-bold leading-[65px] mt-">
              ...
              <p className="text-[17px] leading-7 text-darkGrayishBlue mt-4">
                ...
                Pro FG. It's loaded with a Zoom Air unit, so you can dominate in
                the waning minutes of a match—when it matters most. Fast is in
                the Air.
              </p>
              <div className="flex items-center gap-4 mt-6">
                ...
                <div className=" bg-paleOrange rounded-md">
                  <h5 className="text-[16px] font-bold text-orange py-0.5 px-2.5">
                    50%
                  </h5>
                </div>
              </div>
              <div className="flex items-center mt-16 justify-between">
                <div className=" bg-lightGrayishBlue px-4 flex items-center gap-10 py-1 rounded-md">
                  <span className="text-orange font-bold text-xl cursor-pointer hover:bg-paleOrange rounded-md p-1">
