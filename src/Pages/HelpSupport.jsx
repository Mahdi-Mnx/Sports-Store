...
const HelpSupport = () => {
  return (
    <>
      <motion.section className="pt-20 container max-w-screen-2xl px-6 py-12">
        ...
        <h3 className="text-xl font-semibold mb-2">1. How do I place an order?</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mb-2">3. How can I track my order?</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mb-2">4. What is your return policy?</h3>
        <p className="mb-4">
        ...
        <h3 className="text-xl font-semibold mb-2">5. How do I contact customer support?</h3>
        <p className="mb-4">
        ...
        <ul className="list-disc list-inside mb-4">
          <li><a href="/shipping-info" className="text-blue-500">Shipping Information</a></li>
          <li><a href="/return-policy" className="text-blue-500">Return Policy</a></li>
          <li><a href="/privacy-policy" className="text-blue-500">Privacy Policy</a></li>
          <li><a href="/terms-of-service" className="text-blue-500">Terms of Service</a></li>
        </ul>
