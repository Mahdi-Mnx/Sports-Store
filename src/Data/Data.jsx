const productData = [
  ...
  },
  {
    id: 31,
    brand: "Nike",
    name: "Nike Tiempo Emerald",
    categories: ["Women", "Men", "Shoes"],
    price: 115.99,
    type: "FG Low-Top Football Boot",
    description:
      "Add in FlyTouch Pro and All Conditions Control (a grippy texture even in wet weather) and you're ready to leave your mark over the next three decades.",
    images: [
      "/public/images/tiempo-emerald-legend.png",
      "/public/images/tiempo-emerald-legend-1.jpg",
      "/public/images/tiempo-emerald-legend-2.png",
      "/public/images/tiempo-emerald-legend-3.png",
    ],
  },
  {
    id: 32,
    ...
    type: "FG Low-Top Football Boot",
    description:
      "The result is the most responsive Mercurial we've ever made, because you demand greatness from yourself and your footwear.",
    images: [
      "/public/images/mercurial-superfly-10.jpg",
      "/public/images/mercurial-superfly-10-1.png",
      "/public/images/mercurial-superfly-10-2.png",
      "/public/images/mercurial-superfly-10-3.jpg",
    ],
  },
  {
    id: 33,
    brand: "Nike",
    name: "Nike Jr. Phantom GX 2",
    categories: ["Women", "Men", "Shoes"],
    price: 64.99,
    type: "MG Low-Top Football Boot",
    description:
      "That way, you have control of your shot when the net is in range. We created it with goals in mind. This version celebrates Erling Haaland's Norwegian roots.",
    images: [
      "/public/images/jr-phantom-gx-2-academy-erling-haaland.png",
      "/public/images/jr-phantom-gx-2-academy-erling-haaland-1.png",
      "/public/images/jr-phantom-gx-2-academy-erling-haaland-2.png",
      "/public/images/jr-phantom-gx-2-academy-erling-haaland-3.png",
    ],
  },
  {
    id: 34,
    ...
    categories: ["Men", "Shirts"],
    price: 39.99,
    type: "Men's Dri-FIT 1/2-Zip",
    description:
      "Discreet thumbholes let you extend coverage while keeping the sleeves in place and your hands warm—so you can pass, dribble and shoot without anything holding you back.",
    images: [
      "/public/images/academy-dri-fit-1-2-zip-football-top.png",
      "/public/images/academy-dri-fit-1-2-zip-football-top-1.png",
      "/public/images/academy-dri-fit-1-2-zip-football-top-2.png",
      "/public/images/academy-dri-fit-1-2-zip-football-top-3.png",
    ],
  },
  {
    id: 35,
    ...
    categories: ["Men", "Shirts"],
    price: 22.99,
    type: "Men's Dri-FIT Short-Sleeve",
    description:
      "It's stretchy and light, so you stay quick on your feet as you pass, dribble and shoot. Plus, breathable mesh on the back helps keep things cool.",
    images: [
      "/public/images/academy-dri-fit-short-sleeve.png",
      "/public/images/academy-dri-fit-short-sleeve-1.jpg",
      "/public/images/academy-dri-fit-short-sleeve-2.png",
      "/public/images/academy-dri-fit-short-sleeve-3.png",
    ],
  },
  {
    id: 36,
    ...
    categories: ["Women", "Shirts"],
    price: 22.99,
    type: "Women's Dri-FIT Short-Sleeve",
    description:
      "A replica of what the pros wear, it has sweat-wicking technology to help keep you cool and composed while you fine-tune your skills.",
    images: [
      "/public/images/strike-dri-fit-short-sleeve.png",
      "/public/images/strike-dri-fit-short-sleeve-1.png",
      "/public/images/strike-dri-fit-short-sleeve-2.jpg",
      "/public/images/strike-dri-fit-short-sleeve-3.jpg",
    ],
  },
];
